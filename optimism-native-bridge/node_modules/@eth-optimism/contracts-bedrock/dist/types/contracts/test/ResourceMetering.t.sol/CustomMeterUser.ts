...
export interface CustomMeterUserInterface extends utils.Interface {
  functions: {
    ...
    "MAXIMUM_BASE_FEE()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "MAXIMUM_BASE_FEE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CustomMeterUser extends BaseContract {
  ...
  functions: {
    ...
    MAXIMUM_BASE_FEE(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    MAXIMUM_BASE_FEE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
